...
def load_transformers_model(model_name:str, bnb_config:Optional[BitsAndBytesConfig]=None, flash_attention=False) -> Tuple[PreTrainedModel, PreTrainedTokenizerBase]:
    # Load model and tokenizer
